...
const Template2 = (props) => {
  ...
  return (
    <Paper
      ...
      />
      <Container>Training/Internships
        <TempHeading color={"#C98A55"} Hupcolor={"none"} Hupheight={"none"} Hdowncolor={"#C98A55"} Hdownheight={"none"} title={"Training/Internships"} />
        ...
        <TempHeading color={"#C98A55"} Hupcolor={"none"} Hupheight={"none"} Hdowncolor={"#C98A55"} Hdownheight={"none"} title={"Soft Skills"} />
